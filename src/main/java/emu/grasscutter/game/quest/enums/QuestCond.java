...
public enum QuestCond implements QuestTrigger {
	...
	QUEST_COND_ACTIVITY_SCHEDULE_OPEN_AND_COND(79), // missing
	QUEST_COND_ARANARA_COLLECTION_STATE_EQ(80), // missing
	QUEST_COND_INFERENCE_FINISH_PAGE_CONCLUSION(81), // missing
	QUEST_COND_SCENE_LEVEL_TAG_VALID(82), // missing
	QUEST_COND_NEW_HOMEWORLD_WOOD_EXCHANGE_UNLOCK(83), // missing
	QUEST_COND_IN_CITY(84), // missing
	QUEST_COND_GCG_EXP_OVERFLOW(86), // missing
	QUEST_COND_GCG_NPC_TYPE(87), // missing
	QUEST_COND_ACTIVITY_NEW_FUNGUS_CAPTURE(88), // missing
