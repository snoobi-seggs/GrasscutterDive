...
public enum QuestExec implements QuestTrigger {
	...
	QUEST_EXEC_REFRESH_WORLD_QUEST_FLOW_GROUP_SUITE(71), // missing
	QUEST_EXEC_HIDE_SCENE_POINT(72), // missing
	QUEST_EXEC_UNHIDE_SCENE_POINT(73), // missing
	QUEST_EXEC_REFRESH_WORLD_QUEST_FLOW_GROUP_SUITE_BUILTIN(74), // missing
	QUEST_EXEC_RANDOM_CLOSED_QUEST_VAR(75), // missing
	QUEST_EXEC_OPTIONAL_REVIVAL_TEAM(76), // missing
